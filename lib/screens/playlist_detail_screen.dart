...
import 'package:ultimate_player/services/export_service.dart';
              ...
              child: Consumer2<PlaylistProvider, AudioProvider>(
                builder: (context, playlistProvider, audioProvider, child) {
                   ...
                   return CustomScrollView(
                     slivers: [
                       // Header Section (Image, Song Count, Buttons)
                       SliverToBoxAdapter(
                         child: Column(
                           children: [
                                 ...
                                 child: Row(
                                   ...
                                   children: [
                                      CupertinoButton.filled(
                                        ...
                                        onPressed: () {
                                           Provider.of<AudioProvider>(context, listen: false).playPlaylist(currentPlaylist.songs);
                                        },
                                      ),
                                            ...
                                            actions: [
                                              ...
                                              CupertinoActionSheetAction(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  await exportService.exportSong(song);
                                                },
                                              ),
                                              CupertinoActionSheetAction(
